...
\section{References}
\begin{itemize}
	\item Software Requirements Specification (SRS): \href{https://github.com/alexander89162/CS3338-final-project/blob/Vivian/docs/software_requirement_specification/srs_v1.pdf}{SRS Link}
